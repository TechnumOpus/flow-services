...
//    public ResponseEntity<Page<InventoryBufferDTO>> getInventoryBuffersByProduct(
//            @PathVariable String productId,
//            @RequestParam(defaultValue = "0") @Min(0) int page,
//            @RequestParam(defaultValue = "20") @Min(1) int size) {
...
//        Page<InventoryBufferDTO> buffers = inventoryBufferService.getInventoryBuffersByProduct(productId, pageable);
//        return ResponseEntity.ok(buffers);
//    }
//
//    @GetMapping("/location/{locationId}")
//    public ResponseEntity<Page<InventoryBufferDTO>> getInventoryBuffersByLocation(
//            @PathVariable String locationId,
//            @RequestParam(defaultValue = "0") @Min(0) int page,
//            @RequestParam(defaultValue = "20") @Min(1) int size) {
...
//
//        Pageable pageable = PageRequest.of(page, size, Sort.by("updatedAt").descending());
//        Page<InventoryBufferDTO> buffers = inventoryBufferService.getInventoryBuffersByLocation(locationId, pageable);
//        return ResponseEntity.ok(buffers);
//    }
    ...
    @PutMapping("/{bufferId}/calculate-zone")
